...
export const ClassroomCard = ({ classroom, isTeacher }) => {
  ...
  return (
    <div className="bg-white rounded-2xl p-5 border border-slate-200/80 shadow-xs hover:shadow-md hover:border-brand-200 transition-all flex flex-col justify-between h-full group">
      <div>
        ...
        <p className="text-xs text-slate-500 mt-1.5 line-clamp-2 min-h-[34px] leading-relaxed">
        ...
        <div className="flex items-center justify-between text-xs text-slate-500">
          ...
          {classroom.joinCode && (
            <button
              ...
              className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md bg-slate-100 hover:bg-slate-200 text-slate-700 font-mono text-[11px] font-semibold transition-colors"
            >
